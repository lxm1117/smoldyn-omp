...
gcc testcode.o /usr/local/lib/libsmoldyn.a -o testcode

Dynamic link, if Libsmoldyn was compiled without OpenGL:
gcc testcode.o -o testcode -lsmoldyn

Static link, if Libsmoldyn was compiled with OpenGL:
gcc testcode.o /usr/local/lib/libsmoldyn.a -I/System/Library/Frameworks/OpenGL.framework/Headers -I/System/Library/Frameworks/GLUT.framework/Headers -framework GLUT -framework OpenGL -framework Cocoa -L/System/Library/Frameworks/OpenGL.framework/Libraries -o testcode -ltiff

Dynamic link, if Libsmoldyn was compiled with OpenGL:
gcc testcode.o -I/System/Library/Frameworks/OpenGL.framework/Headers -I/System/Library/Frameworks/GLUT.framework/Headers -framework GLUT -framework OpenGL -framework Cocoa -L/System/Library/Frameworks/OpenGL.framework/Libraries -o testcode -lsmoldyn -ltiff
*/
...
#include <string.h>
#include <stdlib.h>
#include <smoldyn/libsmoldyn.h>			// This line is required for accessing Libsmoldyn
...
int main() {
	...
	products=calloc(2,sizeof(char*));
	products[0]=calloc(256,sizeof(char));
	products[1]=calloc(256,sizeof(char));
